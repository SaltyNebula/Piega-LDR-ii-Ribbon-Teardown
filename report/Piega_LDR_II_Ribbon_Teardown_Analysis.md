...
*Figure 2: Alternating N-S-N bar magnets and rear plate. (The motor is also visible in Figure 1.)*
...
![Frequency response, both units, with the 3.5 kHz crossover cursor](../outputs/ldrii_fr_rew.png)
...
![Harmonic distortion, with the crossover cursor](../outputs/ldrii_thd_rew.png)
